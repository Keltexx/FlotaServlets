...
public class Partida {
	...
	private boolean misDisparos[][] = null; // numero de casillas sobre las que se ha disparado
	...
	public Partida(int nf, int nc, int nb) {
		...
		iniciaDisparos(nf, nc); // inicia toda la matriz a false
    ...
    /**
	 * Devuelve si se ha disparado sobre una casilla
	 * @param	f	fila de la casilla
	 * @param   c   columna de la casilla
	 * @return	    resultado de si se ha disparad sobre casilla
	 */	
	...
	/**
	 * Devuelve la cantidad de disparos efectuados
	...
	/**
	 * Devuelve la cantidad de barcos que quedan
	 * @return	    numero de barcos que quedan
	 */	
	...
	/*
	 * Inicia todas las casillas de la matriz misDisparos a false 
	 * */
